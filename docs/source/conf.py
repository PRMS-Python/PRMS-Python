# -*- coding: utf-8 -*-
#
# PRMS-Python documentation build configuration file, created by
...
# pixels large.
html_favicon = 'prms-python-32x.png'
...
htmlhelp_basename = 'PRMS-Pythondoc'
...
latex_documents = [
    (master_doc, 'PRMS-Python.tex', u'PRMS-Python Documentation',
     u'John Volk and Matthew Turner', 'manual'),
]
...
man_pages = [
    (master_doc, 'prms-python', u'PRMS-Python Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'PRMS-Python', u'PRMS-Python Documentation',
     author, 'PRMS-Python', 'Tools for the PRMS hydrologic model.',
     'Miscellaneous'),
]
